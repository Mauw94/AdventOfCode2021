...
namespace AdventOfCode
{
    public class Day3 : IBase
    {
        ...
        {
            List<string> fileContent = File.ReadAllLines("C:\\Projects\\AdventOfCode\\day3.txt").ToList();
        ...
        public override void Solution2()
        {
            ...
            List<string> fileContent2 = File.ReadAllLines("C:\\Projects\\AdventOfCode\\day3.txt").ToList();
